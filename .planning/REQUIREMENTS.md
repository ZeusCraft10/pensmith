...
- [x] **GATE-04**: The humanized `FINAL.md` is re-checked (deterministic Pass-3 + citekey-set diff) before export, so humanization cannot introduce an unverified or altered citation
